...
class ProprieteAppartements {
  ...
  factory ProprieteAppartements.FromFirestore(DocumentSnapshot document) {
    Timestamp created = (document.data() as Map)['created_at'];
    Timestamp updated = (document.data() as Map)['updated_at'];
    return ProprieteAppartements(
        uid: document.id,
  ...
  ProprieteAppartements copyWith({
    String? uid,
    String? nom,
    String? photo_url,
    String? user_uid,
  ...
  factory ProprieteAppartements.fromMap(Map<String, dynamic> map) {
    return ProprieteAppartements(
      uid: map['uid'] ?? '',
      nom: map['nom'] ?? '',
  ...
  factory ProprieteAppartements.fromJson(String source) =>
      ProprieteAppartements.fromMap(json.decode(source));

  @override
  String toString() {
    return 'ProprieteAppartements(uid: $uid, nom: $nom, photo_url: $photo_url, user_uid: $user_uid, created_at: $created_at, updated_at: $updated_at)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ProprieteAppartements &&
        other.uid == uid &&
        other.nom == nom &&
