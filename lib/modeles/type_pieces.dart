...
class TypePieces {
  ...
  factory TypePieces.FromFirestore(DocumentSnapshot document) {
  ...
  factory TypePieces.fromJson(String source) =>
      TypePieces.fromMap(json.decode(source));

  @override
  String toString() {
    return 'TypePieces(uid: $uid, nom: $nom, user_uid: $user_uid, created_at: $created_at, updated_at: $updated_at)';
  }
