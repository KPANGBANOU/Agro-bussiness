...
class TypeBoissons {
  ...
  factory TypeBoissons.FromFirestore(DocumentSnapshot document) {
  ...
  factory TypeBoissons.fromMap(Map<String, dynamic> map) {
    return TypeBoissons(
      uid: map['uid'] ?? '',
      nom: map['nom'] ?? '',
  ...
  factory TypeBoissons.fromJson(String source) =>
      TypeBoissons.fromMap(json.decode(source));

  @override
  String toString() {
    return 'TypeBoissons(uid: $uid, nom: $nom, user_uid: $user_uid, created_at: $created_at, updated_at: $updated_at)';
  }
