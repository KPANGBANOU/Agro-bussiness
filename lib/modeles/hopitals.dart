...
class Hopitals {
  ...
  factory Hopitals.FromFirestore(DocumentSnapshot document) {
  ...
  factory Hopitals.fromMap(Map<String, dynamic> map) {
    return Hopitals(
      uid: map['uid'] ?? '',
      nom: map['nom'] ?? '',
  ...
  factory Hopitals.fromJson(String source) =>
      Hopitals.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Hopitals(uid: $uid, nom: $nom, user_uid: $user_uid, created_at: $created_at, updated_at: $updated_at)';
  }
