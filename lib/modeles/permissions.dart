...
class Permissions {
  ...
  factory Permissions.FromFirestore(DocumentSnapshot document) {
  ...
  @override
  String toString() {
    return 'Permissions(uid: $uid, nom: $nom, user_uid: $user_uid, created_at: $created_at, updated_at: $updated_at)';
  }
