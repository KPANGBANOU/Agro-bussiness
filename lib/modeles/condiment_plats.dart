...
class Condiments {
  ...
  factory Condiments.FromFirestore(DocumentSnapshot document) {
  ...
  factory Condiments.fromMap(Map<String, dynamic> map) {
    return Condiments(
      uid: map['uid'] ?? '',
      nom: map['nom'] ?? '',
  ...
  factory Condiments.fromJson(String source) =>
      Condiments.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Condiments(uid: $uid, nom: $nom, montant: $montant, description: $description, user_uid: $user_uid, created_at: $created_at, updated_at: $updated_at)';
  }
